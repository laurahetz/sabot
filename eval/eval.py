...
frame = frame.loc[frame['repetition'] <= (int(REPS)-1)]
...
# EXPERIMENT 1: Bandwidth (KB) / No Auth
...
# EXPERIMENT 2: Bandwidth (KB) / Yes Auth
...
# EXPERIMENT 3: Computation / No Auth / All Values S
...
# EXPERIMENT 3: Computation / Yes Auth / All Values S
